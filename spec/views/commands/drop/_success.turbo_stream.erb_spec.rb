...
describe "commands/drop/_success.turbo_stream.erb" do
  subject(:html) do
    render(
  ...
  before do
    stub_template("commands/drop/_success.html.erb" => "SUCCESS_TEMPLATE")
    stub_template("game/sidebar/navigation/_content.html.erb" => "INVENTORY_TEMPLATE")
  ...
  it "replaces the character inventory" do
    expect(html).to have_turbo_stream_element(
      action: "replace",
  ...
  it "renders the inventory template" do
    expect(html).to include("INVENTORY_TEMPLATE")
  end
